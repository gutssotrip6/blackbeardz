    ...
    <div className="relative w-full min-h-screen bg-white text-black" style={colors.cssVars}>
      ...
      <div className="flex flex-col min-h-screen pt-[90px]">
        ...
        <div className="flex-1 px-6 md:px-12 max-w-2xl mx-auto mb-[70px]">
          ...
          >
            <div>
              <p className={`${colors.text} text-sm uppercase tracking-widest mb-2`}>Delivery</p>
              <p className="text-gray-700 text-lg">4 days to all 69 wilayas. Payment on delivery.</p>
            </div>

            <div>
              <p className={`${colors.text} text-sm uppercase tracking-widest mb-2`}>Returns</p>
              <p className="text-gray-700 text-lg">No refunds. All sales are final.</p>
            </div>
          </motion.div>
        </div>
